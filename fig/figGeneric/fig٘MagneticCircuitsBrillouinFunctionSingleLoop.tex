...
\addplot[ domain=\kpi:-\kpi]{0.2*cos(x*90/\kpi)^2+\Brillouin(x)}[arrow inside={}{0.25,0.75}];
%
\addplot[domain=-\kpi:0]{-0.25*cos(x*90/\kpi)^2+\Brillouin(x)}[arrow inside={}{0.25,0.75}];
\pgfmathsetmacro{\kpi}{2.5}
\addplot[domain=0:\kpi]{-0.25*cos(x*90/\kpi)^2+\Brillouin(x)}[arrow inside={}{0.25,0.75}];
\addplot[domain=\kpi:0]{0.25*cos(x*90/\kpi)^2+\Brillouin(x)}[arrow inside={}{0.25,0.75}];
\end{axis}
%
%grid
