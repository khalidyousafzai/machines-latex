...
plot (xshift-txk,-x,"color","black","linewidth",1,xshift-pi+txk,-x,"color","black","linewidth",1,xshift+txp,x,"color","black","linewidth",1,xshift+pi-txp,x,"color","black","linewidth",1)    #excitation current
