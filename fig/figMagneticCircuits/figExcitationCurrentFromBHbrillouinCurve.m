...
plot ([-2,2],[0,0],"color",[0.5,0.5,0.5]);                                                             #axis
plot ([0,0],[1.1*Bn(J,xlmt)+0.4,-1.1*Bn(J,xlmt)],"color",[0.5,0.5,0.5]);      %gray color
...
plot (xshift-txk,-x,"color","black","linewidth",1.5,xshift-pi+txp,-x,"color","black","linewidth",1.5,xshift+txp,x,"color","black","linewidth",1.5,xshift+pi-txk,x,"color","black","linewidth",1.5)    #excitation current

#axis
plot ([xshift-0.4-pi,xshift+0.6+pi],[0,0],"color",[0.5,0.5,0.5]);            
plot ([xshift,xshift],[1.1*Bn(J,xlmt)+0.4,-1.1*Bn(J,xlmt)],"color",[0.5,0.5,0.5]);

t=-pi:0.001:pi;                                      #sine wave flux and axis
plot (xshift+t,Bn(J,xlmt)*sin(t),"linewidth",1);
plot (xshift+t,3*cos(t),"linewidth",1,"color",[0.5,0.5,0.5]);
