...
وہ نظام جس میں متغیرات \عددیء{\rho,\theta,z}  کسی نقطہ کو متعین کرتے  ہوں  \اصطلاح{نلکی محدد}\فرہنگ{محدد!نلکی}\حاشیہب{cylindrical coordinates}\فرہنگ{cylindrical coordinates} کہلاتا ہے۔یہاں شکل \حوالہ{شکل_حقائق_نلکی_نظام_تعریف}  سے رجوع کریں۔ نلکی محددی نظام کے تین آپس میں  قائمہ الزاویہ اکائی  متعامد سمتیات $\arho,\atheta,\az$ ہیں۔ یہ نظام بھی دائیں ہاتھ کا نظام ہے لہٰذا دائیں ہاتھ کا انگوٹھا، شہادت کی انگلی اور  بڑی انگلی کو ایک دوسرے کے ساتھ \عددی{90^{\circ}} پر رکھتے ہوئے اگر  شہادت کی انگلی \عددی{\arho} اور بڑی انگلی \عددی{\atheta} کے رخ ہوں تب انگوٹھا \عددی{\az} کے رخ ہو گا۔ 
...
دو عددیہ متغیرات کا حاصل ضرب عددیہ متغیر ہوتا ہے جبکہ دو سمتیات  کا حاصل ضرب سمتی  یا عددیہ ہو سکتا ہے۔ان دو اقسام کے ضرب پر یہاں غور کیا جائے گا۔
...
\item
چونکہ دونوں سمتیات کے رخ ایک سا  ہیں لہٰذا ان کے مابین زاویہ صفر ہو گا۔صفر زاویہ کا سائن بھی صفر ہوتا ہے، \عددیء{\sin 0 =0}۔ یوں ان دو سمتیات  کی ضرب صلیبی صفر ہو گی۔\\
...
%
\جزوحصہ{نقطوی ضرب}
دو سمتی متغیرات  کا ایسا حاصل ضرب جو عددیہ متغیر ہو \اصطلاح{نقطوی  ضرب}\فرہنگ{ضرب!نقطوی}\حاشیہب{dot product}\فرہنگ{dot product} کہلاتا ہے جو درج ذیل لکھا جاتا ہے۔
\begin{align}
