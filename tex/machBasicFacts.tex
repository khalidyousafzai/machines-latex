...
\end{align}
یہ ایک بہت اہم نتیجہ ہے جو آپ کو زبانی یاد ہونا چاہئے۔ یہ مساوات ہر سائن نما تفاعل کے لیے درست ہے۔کسی بھی متغیرہ کے مربع کی اوسط کا جذر اس متغیرہ کی \اصطلاح{موثر}\حاشیہب{effective} قیمت کہلاتی ہے۔
%
\begin{figure}
\centering
