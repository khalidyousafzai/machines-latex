...
\حصہ{عددیہ}
وہ متغیر جس کی مقدار (مطلق قیمت) اس کو مکمل طور پر بیان کرتی ہو  \اصطلاح{عددیہ}\فرہنگ{عددیہ}\حاشیہب{scalar}\فرہنگ{scalar}  متغیر کہلاتا ہے۔ اس کتاب میں عددیہ متغیر کو سادہ طرز کی لکھائی میں انگریزی یا لاطینی زبان کے چھوٹے حروف  یعنی \عددی{a,b,\alpha,\cdots}  یا بڑے حروف یعنی  \عددی{A,B,\Psi,\cdots} سے ظاہر کیا جائے گا، مثلاً برقی رو کو \عددی{i} یا \عددی{I} سے ظاہر کیا جاتا ہے۔

\حصہ{سمتیہ}
وہ متغیر جس کو مکمل طور پر بیان کرنے کے لیے اس کی مقدار (طول یا مطلق قیمت) اور سمت جاننا ضروری ہو،  \اصطلاح{سمتیہ}\فرہنگ{سمتیہ}\حاشیہب{vector}\فرہنگ{vector} کہلاتا ہے۔ سمتیہ کو انگریزی یا لاطینی زبان کے چھوٹے یا  بڑے حروف،  جن کو موٹے طرز کی لکھائی میں لکھا گیا ہو،  سے ظاہر کیا جائے گا، مثلاً قوت کو \سمتیہ{F} سے ظاہر کیا جائے گا۔یہاں شکل \حوالہ{شکل_حقائق_اکائی_سمتیہ}  سے رجوع کرنا بہتر ہو گا۔ وہ سمتیہ جس کا طول ایک کے برابر ہو، \اصطلاح{اکائی سمتیہ}\فرہنگ{اکائی سمتیہ}\حاشیہب{unit vector}\فرہنگ{unit vector} کہلائے گا۔ اس کتاب میں اکائی سمتیہ کو انگریزی زبان کے پہلے حرف کو موٹے طرز کی لکھائی میں لکھا جائے گا، مثلاً اکائی سمتیہ \عددیء{\ax,\ay,\az} خلاء کی تین  آپس میں قائمہ الزاویہ سمتیات  کو ظاہر کرتے ہیں۔\عددیء{\ax} لکھتے ہوئے، زیر نوشت میں \عددیء{x}، اس بات کی نشاندہی  کرتا ہے کہ یہ اکائی سمتیہ خلاء کی \عددیء{x} سمت کو ظاہر کرتا ہے۔ اگر کسی سمتیہ  کا طول اور اس کی سمت کو علیحدہ علیحدہ لکھنا ہو تو اس کے طول کو ظاہر کرنے کے لیے سادہ طرز کی لکھائی میں وہی حرف استعمال کیا جائے گا جو اس سمتیہ کو ظاہر کرنے کے لیے، موٹے طرز کی لکھائی میں، استعمال کیا گیا ہو۔ یعنی سمتیہ \سمتیہ{F} کے طول کو \عددیء{F} سے ظاہر کیا جائے گا۔ شکل میں سمتیہ  \سمتیہ{F} کا طول \عددیء{F}، چار کے برابر ہے۔ اگر کسی سمتیہ کی سمت میں ایک اکائی سمتیہ بنایا جائے تو یہ اکائی سمتیہ اس سمتیہ کی سمت کو ظاہر کرتا ہے۔جیسے پہلے ذکر ہوا ہے  ایسے اکائی سمتیہ کو انگریزی کے پہلے حرف،  جس کو موٹے طرز کی لکھائی میں لکھا گیا ہو  سے ظاہر کیا جائے گا یعنی سمتیہ \سمتیہ{F} کی سمت کو \عددیء{\سمتیہ{a}_F} سے ظاہر کیا جائے گا۔یہاں،  زیر نوشت میں \عددیء{F} ، اس بات کی یاد دہانی کراتا ہے کہ یہ اکائی سمتیہ \سمتیہ{F} کی سمت کو ظاہر کرتا ہے۔ شکل \حوالہ{شکل_حقائق_اکائی_سمتیہ} میں قوت \سمتیہ{F} کا رخ دائیں  ہے لہٰذا  \عددیء{\سمتیہ{a}_F} اور  \عددیء{\ax} برابر ہوں گے۔
\begin{figure}
\centering
...
خلاء  تین بعدی (تین طرفہ) \حاشیہب{three dimensional} ہے لہٰذا  کسی ایک نقطہ کے مقام کو تین محدد کی مدد سے ظاہر کیا جا سکتا ہے۔اسی طرح  خلاء میں سمتیہ کو تین اکائی متعامد سمتیوں کی مدد سے لکھا جا سکتا ہے۔اب ہم ایسے چند محدد کے نظام دیکھتے ہیں۔

\جزوحصہ{کارتیسی محدد نظام}
شکل \حوالہ{شکل_حقائق_اکائی_سمتیہ}   میں خلاء کی دو سمتوں کو  اکائی سمتیات \عددیء{\ax} اور \عددیء{\ay} سے ظاہر کیا گیا ہے جو آپس میں عمودی ہیں، یعنی، ان کے بیچ \عددیء{90^{\circ}}  زاویہ ہے۔خلاء تین بعدی ہے لہٰذا اسے تین آپس میں \اصطلاح{اکائی متعامد سمتیات}\فرہنگ{سمتیہ!اکائی متعامد}\حاشیہب{orthonormal vectors}\فرہنگ{orthonormal} سے ظاہر کیا جاتا ہے۔ ان سمتوں کے رخ،  طول (لمبائیوں)  کو \عددیء{x,y,z} سے ظاہر کیا جاتا ہے۔ آپ ان سے بخوبی واقف ہیں۔ 

 دائیں ہاتھ کا انگوٹھا، شہادت کی انگلی اور  بڑی انگلی کو ایک دوسرے کے ساتھ \عددی{90^{\circ}} زاویہ پر رکھتے ہوئے اگر شہادت کی انگلی \عددی{\ax} اور بڑی انگلی \عددی{\ay} کے رخ ہوں تب انگوٹھا \عددی{\az} کے رخ ہو گا (شکل \حوالہ{شکل_حقائق_دائیں_ہاتھ})۔ اسی لیے  تین اکائی سمتیات کا یہ نظام \اصطلاح{دائیں ہاتھ کا نظام}\حاشیہب{right handed coordinate system}  کہلاتا ہے۔

\begin{figure}
\centering
\begin{tikzpicture}
    \node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[height=3.5cm]{figRightHandRule}};
    \begin{scope}[x={(image.south east)},y={(image.north west)}]
 %\draw[red,step=0.1] (0,0) grid (1,1);
\draw[-latex](0.3,0.9)--(0.2,1)node[left]{$\kvec{a}_x$};
\draw[-latex](0,0.4)--(-0.15,0.35)node[left]{$\kvec{a}_y$};
\draw[-latex](0.9,0.9)--(1,1)node[right]{$\kvec{a}_z$};
    \end{scope}
\end{tikzpicture}
...
\draw[thin,-latex] (\kkkx,\kkky,0)--(\kkkx,\kkky,\kkkz)  node[pos=0.7, right]{${\bf{A}}_z$}node[right,shift={(0.1em,-0.3em)},fill=white]{$P(x,y,z)$};
\end{tikzpicture}%
...
\draw[gray] (0,0,0) -- (0,0,1);
%equations
\node[anchor=east] at (0,2.5,0.5) {$\begin{aligned}
...
وہ نظام جس میں متغیرات \عددیء{\rho,\theta,z}  کسی نقطہ کو متعین کرتے  ہوں  \اصطلاح{نلکی محدد}\فرہنگ{محدد!نلکی}\حاشیہب{cylindrical coordinates}\فرہنگ{cylindrical coordinates} کہلاتا ہے۔یہاں شکل \حوالہ{شکل_حقائق_نلکی_نظام_تعریف}  سے رجوع کریں۔ نلکی محدد نظام کے تین آپس میں  قائمہ الزاویہ اکائی  متعامد سمتیات $\arho,\atheta,\az$ ہیں۔ یہ نظام بھی دائیں ہاتھ کا نظام ہے لہٰذا دائیں ہاتھ کا انگوٹھا، شہادت کی انگلی اور  بڑی انگلی کو ایک دوسرے کے ساتھ \عددی{90^{\circ}} پر رکھتے ہوئے اگر  شہادت کی انگلی \عددی{\arho} اور بڑی انگلی \عددی{\atheta} کے رخ ہوں تب انگوٹھا \عددی{\az} کے رخ ہو گا۔ 

سطح \عددی{xy} میں مبدا پر، محدد \عددی{x} کے ساتھ  \عددی{\theta} زاویہ پر اکائی سمتیہ  $\arho$ ہو گا۔  سطح  \عددیء{xy} میں مبدا پر اکائی سمتیہ $\arho$ کے عمودی، بڑھتے  \عددی{\theta} رخ، اکائی   سمتیہ $\atheta$ ہو گا۔ کارتیسی محدد نظام کا اکائی سمتیہ $\az$ ہی نلکی محدد کا اکائی سمتیہ $\az$ ہے۔ 
\begin{figure}
\centering
...
%\draw[dashed] (0,0,\kkkz)--(\kkkx,0,\kkkz);
%vectors
\draw[thin,] (0,0,0)--(\kkkx,\kkky,0)  node[pos=0.6, above]{${\rho}$};
\draw[thick,-latex] (0,0,0)--(\kkkx,\kkky,\kkkz) node[pos=0.4, above]{$\bf{A}$};
%\draw[thin,-latex] (0,0,0)--(\kkkx,0,0) node[pos=0.6, right]{${\bf{A}}_x$};
%\draw[thin,-latex] (\kkkx,0,0)--(\kkkx,\kkky,0)  node[pos=0.6, below]{${\bf{A}}_y$};
...
%vectors
\draw[thin,] (0,0,0)--(\kkkx,\kkky,0)  node[pos=0.6, below]{${\rho_1}$};
...
\def\height{0.4};
%axis
\draw[] (0,0,0) -- (1.3*\kradius,0,0) node[below] {$x$};
\draw[] (0,0,0) -- (0,1.2*\kradius,0) node[right] {$y$};
\draw[] (0,0,0) -- (0,0,0.75*\kradius) node[above] {$z$};

%circle
\tdplotdrawarc[dashed]{(O)}{\kradius}{0}{360}{}{};
%vectors
...
\draw[-latex] (0,0,0)--(\kradius * \costheta,\kradius * \sintheta,0)  node[pos=0.5, above]{${\rho_0}$};
%text
\tdplotdrawarc[->]{(0,0,0)}{0.35}{0}{\angleA}{anchor=north,color=black}{$\theta$};
...
\draw[dashed] (Oc) -- ++(\kradius,0,0);  %hidden axis
\draw[dashed] (Oc) -- ++(0,\kradius,0);
\draw[dashed] (Oc) -- ++(0,0,\height);

\draw[] (Oc)++(\kradius,0,0) -- ++(0.3,0,0)node[below ] {$x$};  %visible axis
\draw[] (Oc)++(0,\kradius,0) -- ++(0,0.2,0)node[right ] {$y$};
\draw[] (Oc)++(0,0,\height) -- ++(0,0,0.3)node[above] {$z$};

%top and bottom of cylinder
\tdplotdrawarc[dashed]{(Oc)}{\kradius}{110}{290}{}{};   %bottom of cylinder
\tdplotdrawarc[]{(Oc)}{\kradius}{-70}{110}{}{};
\tdplotdrawarc[]{(Occ)}{\kradius}{0}{360}{}{};   %top of cylinder
...
\draw[<->](leftLowerL)--(leftUpperL) node[pos=0.5,left]{$z_0$};
...
\draw[dotted](Oc)--++(\kradius * \costheta,\kradius * \sintheta, 0)node[pos=0.5,black,below] {$\rho_0$}; %vector horizontal section lower
\draw[dotted](Oc)++(0,0,0.8*\height) --++(\kradius * \costheta,\kradius * \sintheta,0); %vector horizontal section upper
\draw[dotted](Oc)++(\kradius * \costheta,\kradius * \sintheta, 0)--++(0,0,0.8*\height); %vector vertical section
%showing angle
 \tdplotdrawarc[-latex,tdplot_main_coords]{(Oc)}{0.3}{0}{70}{anchor=north,black}{$\theta$};
%\tdplotdrawarc[color=gray,-latex,tdplot_main_coords]{(0,0,0)}{0.5}{0}{15}{anchor=north west}{$\theta_2$};
...
\kvec{a_{A1}}&=\az
\end{align*}
یوں بالائی سطح کا سمتیہ رقبہ درج ذیل ہو گا۔
\begin{align}
...
\end{align}
دھیان  رہے کہ رقبہ کی مقدار ہر صورت  مثبت ہو گی البتہ اس کا رخ مثبت یا منفی ہو سکتا ہے۔ یہ بات کسی بھی سمتیہ کے لیے درست ہے لہٰذا کسی بھی سمتیہ کا طول ہر صورت  مثبت ہی ہو گا جبکہ  اس کا رخ  مثبت یا منفی ہو سکتا  ہے۔
...
\kvec{a_A}=\ay
\end{align}
شکل \حوالہ{شکل_حقائق_رقبہ_عمودی}  میں  اکائی سمتیات  $\ay$  اور  $\az$ دکھائے گئے ہیں جن کے ابتدائی نقاط پر گول دائرہ میں بند ایک نقطہ دکھایا گیا ہے۔گول دائرہ میں بند نقطہ صفحہ کے لمب  (کتاب سے باہر)  رخ  $\ax$ ظاہر کرتا ہے جس کے مخالف رخ  (صفحہ کے لمب  اندر)  کو گول دائرہ میں بند صلیب کی نشان سے ظاہر کیا جائے گا۔
%
\begin{figure}
\centering
...
برقی میدان میں اکائی مثبت بار پر قوت اس مقام پر  \اصطلاح{برقی میدان کی شدت}\فرہنگ{برقی میدان!شدت}\حاشیہب{electric field intensity}\فرہنگ{electric field!intensity} (\سمتیہ{E} کی مطلق قیمت) دے گا جبکہ اکائی بار پر قوت کا رخ برقی میدان کا رخ دے گا۔برقی میدان کی شدت کی اکائی \اصطلاح{وولٹ فی میٹر}\حاشیہب{\si{\volt / \meter}} ہے۔
...
\جزوحصہ{سطحی کثافت}
اکائی رقبہ کی سطح پر کسی چیز کی کُل مقدار کو اس چیز کی \اصطلاح{سطحی کثافت}\فرہنگ{سطحی کثافت}\حاشیہب{surface density}\فرہنگ{surface density} کہتے ہیں۔ یوں رقبہ \عددیء{A} پر کسی چیز کی کُل مقدار  \عددیء{\phi} ہونے کی صورت میں اس  کی اوسط سطحی کثافت \سیدھازیرنوشت{B}{اوسط}   درج ذیل ہو گی۔
\begin{align}
...
\phi=B_{\textup{اوسط}} A
\end{align}
لکھا جا سکتا ہے جو کسی سطح پر ایک متغیرہ کی اوسط سطحی کثافت معلوم ہونے کی صورت میں  سطح پر متغیرہ کی کُل مقدار دیتی ہے۔
...
\dif \phi =B \dif A
\end{align}
بھی لکھا  جا سکتا ہے۔  یوں نقطی کثافت جانتے ہوئے  ایک نقطہ کے  چھوٹے  رقبہ پر  متغیرہ کی  کُل (چھوٹی) مقدار معلوم کی جا سکتی ہے۔
...
\حصہ{حجمی کثافت}
  اکائی حجم میں کسی چیز کی کُل مقدار کو اس چیز کی \اصطلاح{حجمی کثافت} کہتے ہیں۔یوں اگر کسی چیز کا حجم \عددیء{H} اور اس کی کمیت \عددیء{m} ہو تب اس کی اوسط (کمیتی) حجمی کثافت درج ذیل  ہو گی۔
\begin{align}
...
\حصہ{صلیبی ضرب اور نقطوی ضرب}
دو عددیہ متغیرات کا حاصل ضرب عددیہ متغیر ہوتا ہے جبکہ دو سمتیات  کا حاصل ضرب سمتیہ  یا عددیہ ہو سکتا ہے۔ان دو اقسام کے ضرب پر یہاں غور کیا جائے گا۔

\جزوحصہ{صلیبی ضرب}
دو سمتیہ متغیرات  کا ایسا ضرب جو سمتیہ متغیر دیتا ہو  \اصطلاح{صلیبی ضرب}\فرہنگ{صلیبی ضرب}\حاشیہب{cross product}\فرہنگ{cross product} کہلاتا اور درج ذیل لکھا جاتا ہے۔
\begin{align}
\kvec{C}=\kvec{A} \times \kvec{B}
\end{align}
صلیبی ضرب میں ضرب کے نشان کو صلیب کی علامت سے ظاہر کیا جاتا ہے جس کی وجہ سے اس کو صلیبی ضرب کہتے ہیں۔
...
\item
چونکہ دونوں سمتیات کے رخ ایک سا  ہیں لہٰذا ان کے مابین زاویہ صفر ہو گا۔صفر زاویہ کا سائن بھی صفر ہوتا ہے، \عددیء{\sin 0 =0}۔ یوں ان دو سمتیات  کی صلیبی ضرب صفر ہو گی۔\\
...
%
\ابتدا{مثال}
شکل \حوالہ{شکل_حقائق_کارتیسی_مروڑ_کا_حل} میں  چار نیوٹن کی قوت \سمتیہ{F} محور سے تین میٹر کی سمتیہ فاصلہ \سمتیہ{L}  پر لاگو ہے جس  کی تفصیل شکل میں دی گئی ہے۔اس قوت کی قوت مروڑ  حاصل کریں۔
حل:	قوت مروڑ \سمتیہ{T} کی تعریف درج ذیل  ہے۔
\begin{align}
\kvec{T}=\kvec{L} \times \kvec{F}
\end{align}
کارتیسی نظام میں یہ سمتیہ فاصلہ
\begin{align}
...
&= L F \sin \theta \az
\end{align*} 
ہو گا جہاں پچھلی مثال کی مدد سے \عددیء{\ax \times \ay=\az} اور \عددیء{\ay \times \ay=0} لیے گئے ہیں۔یوں درج ذیل ہو گا۔
\begin{align*}
\kvec{T}= L F \sin \theta \az=12 \sin \theta \az \quad \si{\newton \meter}
\end{align*}
اس مثال میں \عددیء{\theta_{LF}=180^{\circ}-\theta} ہے۔چونکہ کسی بھی زاویہ \عددیء{\alpha}   کے لیے \عددیء{\sin \alpha=\sin(180^{\circ}-\alpha)} ہوتا ہے لہٰذا اس قوت مروڑ کو درج ذیل بھی لکھا جا سکتا ہے۔
\begin{align*}
\kvec{T}&=LF\sin \theta \az\\
&=L F \sin \theta_{LF}\az
\end{align*}
یہی جواب صلیبی ضرب کی تعریف یعنی مساوات \حوالہ{مساوات_بنیادی_ضرب_صلیبی_تعریف} اور دائیں ہاتھ کے قانون کی مدد سے زیادہ آسانی سے حاصل ہوتا ہے۔
\انتہا{مثال}
%
\begin{figure}
\centering
...
%
\جزوحصہ{نقطوی ضرب}
دو سمتیہ متغیرات  کا ایسا حاصل ضرب جو عددیہ متغیر ہو \اصطلاح{نقطوی  ضرب}\فرہنگ{ضرب!نقطوی}\حاشیہب{dot product}\فرہنگ{dot product} کہلاتا ہے جو درج ذیل لکھا جاتا ہے۔
\begin{align}
\kvec{C}=\kvec{A} \cdot \kvec{B}
\end{align}
نقطوی ضرب میں ضرب کے نشان کو نقطہ کی علامت سے ظاہر کیا جاتا ہے جس کی وجہ سے اس کا نام نقطوی ضرب ہے۔

نقطوی ضرب کی مقدار  درج ذیل ہو گی
\begin{gather}
...
\ابتدا{مثال}
مندرجہ ذیل نقطوی ضرب حاصل کریں۔
\begin{itemize}
\item
...
\item
$\ax \cdot \ay =(1) (1) \cos 90^{\circ}=0$
\item
$\ay \cdot \az =(1) (1) \cos 90^{\circ}=0$
\item
$\arho \cdot \arho =(1) (1) \cos 0=1$
\item
$\arho \cdot \atheta =(1) (1) \cos 90^{\circ}=0$
\end{itemize}
\انتہا{مثال}
%=========================
\ابتدا{مثال}
...
\end{figure}
جہاں پچھلی مثال کی مدد سے \عددیء{\ax \cdot \ax=1} اور \عددیء{\ax \cdot \ay=0} لیے گئے ہیں۔ یہی جواب نقطوی ضرب کی تعریف، مساوات \حوالہ{مساوات_بنیادی_ضرب_نقطہ_تعریف}،  سے با آسانی حاصل ہوتا ہے۔
\انتہا{مثال}
%
...
\end{aligned}
\end{gather}
تفاعل کے مربع کی اوسط کا جذر نہایت اہم قیمت ہے جو تفاعل کی \اصطلاح{مؤثر}\فرہنگ{مؤثر}\حاشیہب{rms, root mean square}\فرہنگ{rms} قیمت کہلاتی ہے اور  جسے  \عددیء{B_{\textup{مؤثر}}} لکھا جاتا ہے۔
\begin{align}\label{مساوات_بنیادی_سائن_نما_کی_موثر_قیمت}
B_{\textup{مؤثر}}=\sqrt{B^2_{\textup{اوسط}}}=\frac{B_0}{\sqrt{2}}
\end{align}
یہ ایک بہت اہم نتیجہ ہے جو آپ کو زبانی یاد ہونا چاہئے۔ یہ مساوات ہر سائن نما تفاعل کے لیے درست ہے۔کسی بھی متغیرہ کے مربع کی اوسط کا جذر اس متغیرہ کی \اصطلاح{مؤثر}\حاشیہب{effective} قیمت کہلاتی ہے۔
%
\begin{figure}
\centering
...
\end{figure}
\حصہ{سطحی تکمل}
فرض کریں   شکل  \حوالہ{شکل_حقائق_نلکی_سطحی_تکمل} میں نلکی کے بیرونی سطح پر سطحی کثافت، \عددیء{B}،  کی قیمت مساوات \حوالہ{مساوات_بنیادی_سائن_نما_تفاعل} دیتی ہے۔  ہم آدھے بیرونی سطح، زاویہ \عددیء{-\pi/2} تا \عددیء{\pi/2}،  کے بیچ اس کی کُل مقدار \عددیء{\phi} معلوم کرتے ہیں۔اس سطح میں نلکی کے سر شامل نہیں ہیں۔

ہم نلکی کے بیرونی سطح پر  خطہ \عددیء{abcd} لیتے ہیں جس کی چوڑائی \عددیء{\rho \Delta\theta}، لمبائی \عددیء{l} اور  رقبہ   \عددیء{\Delta A}  ہے۔\عددیء{\Delta \theta} کو نہایت کم کرتے ہوئے  رقبہ \عددیء{\dif A=\rho l \dif \theta} حاصل ہو گا۔اس سطح پر \عددیء{B} کی مقدار محوری لمبائی  کے ساتھ تبدیل نہیں ہوتی ہے۔سطح \عددیء{\dif A}  پر \عددیء{\dif \phi=B \dif A} اور کُل \عددیء{\phi} درج ذیل ہو گا۔
\begin{figure}
\centering
...
\end{figure}
سائن نما امواج جن کی تعدد معین ہو کو دوری سمتیہ سے ظاہر کرنا  مفید ثابت ہوتا ہے۔ مساوات \اصطلاح{یولر}\فرہنگ{یولر مساوات}\حاشیہب{Euler's equation}\فرہنگ{Euler}
\begin{align}
...
\end{align}
اس سے ثابت ہوتا ہے کہ کوسائن موج دراصل دو مخلوط اعداد کا مجموعہ ہے۔ مساوات یولر ایک مخلوط عدد کو ظاہر کرتا ہے جس کے دو جزو ہیں۔ اس کا ایک جزو حقیقی عدد ہے اور اس کا دوسرا جزو فرضی عدد ہے۔اس کا حقیقی جزو کوسائن موج کو ظاہر کرتا ہے۔ لہٰذا ایک کوسائن موج  \عددیء{A_0 e^{j(\omega t +\phi)}} یا \عددیء{A_0 e^{-j(\omega t +\phi)}} کا حقیقی جزو ہوتا ہے۔ رسمی طور پر سائن نما امواج کو \عددیء{A_0 e^{j(\omega t +\phi)}} سے ظاہر کیا جاتا ہے جس کو مختصراً \عددیء{A_0 e^{j\phi}} یا  \عددیء{A_0 \phase{\phi}} لکھا جاتا ہے جو  \اصطلاح{دوری سمتیہ}\فرہنگ{دوری سمتیہ}\حاشیہب{phasor}\فرہنگ{phasor} کہلاتا ہے۔ دوری سمتیہ کا طول \عددیء{A_0} اور افقی لکیر کے ساتھ زاویہ \عددیء{\phi} ہے۔

دوری سمتیہ استعمال کرتے وقت آپ کو یہ ذہن میں رکھنا ہو گا کہ یہ درحقیقت ایک کوسائن موج ہے جس کا حیطہ  \عددیء{A_0} ، زاویائی فاصلہ  \عددیء{\phi} اور زاویائی تعدد \عددیء{\omega} ہے۔

اس کتاب میں دوری سمتیات کو سادہ طرز لکھائی میں انگریزی کے بڑے حروف جن پر ٹوپی کا نشان ہو سے ظاہر کیا جائے گا، یعنی \عددیء{\hat{I},\hat{V}}  وغیرہ اور ان کے طول کو بغیر ٹوپی کے نشان کے اسی حرف سے ظاہر کیا جائے گا۔یوں برقی دباؤ \عددیء{v= 20 \cos (\omega t +\frac{\pi}{3})} کے لیے درج ذیل درست ہو گا۔
\begin{gather}
\begin{aligned}
...
دوری سمتیات کو عام سمتیات کی طرح ہی تصور کیا جاتا ہے۔ اس مساوات میں \عددیء{\hat{V}} کا طول \عددیء{20} اور افقی لکیر سے زاویہ  \عددیء{\tfrac{\pi}{3}} ریڈیئن ہے۔زاویہ  کو افقی لکیر سے گھڑی  مخالف رخ ناپا جاتا ہے۔افقی لکیر سے گھڑی وار رخ  منفی زاویہ ہو گا۔ شکل \حوالہ{شکل_حقائق_دوری_سمتیات} میں اس \عددیء{\hat{V}} کے علاوہ چند دوسرے  دوری سمتیات بھی  دکھائے گئے ہیں۔

برقی ادوار میں عموماً برقی دباؤ \عددیء{\hat{V}} کے حوالہ سے  برقی رو  \عددیء{\hat{I}} کا زاویہ بیان کیا جاتا ہے۔شکل \حوالہ{شکل_حقائق_دوری_سمتیات}   میں \عددیء{\hat{I_1}} تیس درجہ برقی دباؤ سے آگے ہے جبکہ  \عددیء{\hat{I_2}}  پینتالیس درجہ  برقی دباؤ کے  پیچھے  ہے۔ہم کہتے ہیں \عددیء{\hat{I_1}} تیس درجہ  \اصطلاح{پیش زاویہ}\فرہنگ{پیش زاویہ}\حاشیہب{leading angle}\فرہنگ{leading}  جبکہ  \عددیء{\hat{I_2}} پینتالیس درجہ  \اصطلاح{تاخیری زاویہ}\فرہنگ{تاخیری زاویہ}\حاشیہب{lagging angle}\فرہنگ{lagging} پر ہے۔یوں  \عددیء{\hat{I_1}} \اصطلاح{پیش}  رو جبکہ \عددیء{\hat{I_2}}  \اصطلاح{تاخیری}  رو کہلاتی  ہیں۔دو دوری سمتیات کے بیچ زاویے کو \اصطلاح{ زاویائی فرق}\فرہنگ{زاویائی فرق}\حاشیہب{phase difference}\فرہنگ{phase difference} کہتے ہیں لہٰذا \عددیء{\hat{I_1}} اور \عددیء{\hat{I_2}} میں \عددیء{75 ^{\circ}}  زاویائی فرق پایا جاتا ہے۔یہاں  دھیان رہے کہ شکل \حوالہ{شکل_حقائق_دوری_سمتیات} میں  \عددیء{45^{\circ}} مثبت لکھا گیا ہے۔چونکہ یہ افقی لکیر سے زاویہ ناپنے کے الٹ رخ ہے لہٰذا یہ ایک منفی زاویہ ہے۔

اگر \عددیء{v=V_0 \cos \omega t} اور \عددیء{i=I_0 \cos (\omega t +\theta)} ہوں، جہاں \عددی{V_0} اور \عددی{I_0} مؤثر قیمتیں ہیں، تب برقی طاقت \عددیء{p=V_0 I_0 \cos \theta} ہو گا جہاں \عددیء{\cos \theta} کو \اصطلاح{جزو طاقت}\فرہنگ{جزو طاقت}\حاشیہب{power factor}\فرہنگ{power factor}  اور \عددیء{\theta} کو \اصطلاح{زاویہ جزو طاقت}\فرہنگ{زاویہ جزو طاقت}\حاشیہب{power factor angle}\فرہنگ{power factor angle} کہتے ہیں۔ اسی طرح \اصطلاح{تاخیری} زاویہ کی صورت میں \عددیء{\cos \theta} کو \اصطلاح{تاخیری جزو طاقت}\فرہنگ{جزو طاقت!تاخیری}\حاشیہب{lagging power factor}\فرہنگ{power factor!lagging} اور \اصطلاح{پیش} زاویہ کی صورت میں \عددیء{\cos \theta} کو \اصطلاح{پیش جزو طاقت}\فرہنگ{جزو طاقت!پیش}\حاشیہب{leading power factor}\فرہنگ{power factor!leading} کہتے ہیں۔

آئیں دوری سمتیات  استعمال کرتے ہوئے  ایک سادہ برقی دور حل کرتے ہیں۔ یوں دوری سمتیات سے وابستگی پیدا ہو گی اور ان کا استعمال بھی سیکھ لیں گے۔
\begin{figure}
\centering
...
$};
\end{tikzpicture}
\caption{دوری سمتیات کی مدد سے \عددیء{RL} دور کا حل۔}
\label{شکل_حقائق_دوری_سمتیہ_سے_دور_حل}
\end{figure}

شکل \حوالہ{شکل_حقائق_دوری_سمتیہ_سے_دور_حل}   ایک سادہ \عددیء{R-L} \اصطلاح{یک دوری}\فرہنگ{یک دوری}\حاشیہب{single phase}\فرہنگ{single phase} برقی دور ہے جس پر درج ذیل دباؤ لاگو کیا جاتا ہے۔
\begin{gather}
\begin{aligned}
v(t)&=V_0 \cos (\omega t +\alpha)\\
...
\end{aligned}
\end{gather}
دوری سمتیات کے استعمال سے ہم  برقی رو \عددی{\hat{I}} معلوم کرتے ہیں
\begin{gather}
\begin{aligned}
...
\end{aligned}
\end{gather}
جہاں \عددیء{\phi_Z=\tan^{-1}\tfrac{X}{R}} رکاوٹ کا زاویہ اور \عددی{I_0=\tfrac{V_0}{\abs{Z}}}   ہیں۔یوں  برقی رو درج ذیل ہو گی۔
