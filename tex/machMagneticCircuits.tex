...
\end{align}
خلائی درز کی لمبائی \عددیء{l_a} قالب کے رقبہ عمودی تراش کے اضلاع \عددیء{b} اور \عددیء{w} سے بہت کم ہونے کی صورت ، یعنی  \عددیء{l_a \ll b} اور \عددیء{l_a \ll w}، میں خلائی درز کے رقبہ عمودی تراش \عددیء{A_a} کو قالب کے رقبہ عمودی تراش \عددیء{\Re_c} کے برابر تصور کیا  جا سکتا ہے:
\begin{align}
A_a=A_c=w b
\end{align}
...
شکل \حوالہ{شکل_مقناطیسی__سادہ_مقناطیسی_دور_بغیر_درز} میں ایک سادہ مقناطیسی نظام دکھایا گیا ہے جس میں قالب کے مقناطیسی مستقل کو محدود تصور کرتے ہیں۔مقناطیسی دباو  \عددیء{\tau=N i} مقناطیسی قالب میں مقناطیسی بہاو \عددیء{\phi_c} پیدا کرتا ہے۔ قالب کا رقبہ عمودی تراش \عددیء{A_c}  ہر مقام پر  یکساں ہے اور قالب  کی اوسط لمبائی \عددیء{l_c} ہے۔ قالب میں مقناطیسی بہاو  کا رخ
  \اصطلاح{فلیمنگ}\حاشیہد{فلیمنگ!دایاں ہاتھ قانون} کے دائیں ہاتھ کے قانون\حاشیہب{Fleming's right hand rule}  سے معلوم کیا جا سکتا ہے۔اس قانون کو دو طریقوں سے بیان کیا جا سکتا ہے۔
\begin{itemize}
\item
...
l_c&=2(h-b)+2(m-b)-l_a\\
&=2(0.2-0.01)+2(0.1-0.01)-0.001=\SI{0.359}{\meter}
\end{align*}
%
\begin{align*}
\Re_c&=\frac{l_c}{\mu_r \mu_0 A_c}=\frac{0.359}{40000 \times 4 \pi 10^{-7} \times 0.0002}=\SI{55605}{\ampere \cdot t \per \weber}\\
