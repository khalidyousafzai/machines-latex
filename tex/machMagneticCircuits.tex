...
\end{align}
اس مساوات میں مقناطیسی بہاو کا حیطہ  \عددیء{\mp\phi_0}، کثافت مقناطیسی بہاو کا حیطہ \عددیء{\mp B_0}، قالب کا رقبہ عمودی تراش  \عددیء{A_c} (جو ہر مقام پر یکساں ہے)، زاویائی تعدد  \عددیء{\omega = 2 \pi f} اور تعدد \عددیء{f}  ہے۔
...
\end{align}
جہاں  \عددیء{A_c l_c} قالب کا حجم ہے۔ یوں   \عددیء{A_c l_c} حجم کے قالب  کو \عددیء{B_0} کثافتِ مقناطیسی بہاو تک ہیجان کرنے کے لئے درکار \عددیء{E_{rms} i_{\varphi,rms}} مساوات \حوالہ{مساوات_مقناطیسی_دور_درکار_دباو_ضرب_رو}  دے گی۔ ایک مقناطیسی قالب جس کا حجم  \عددیء{A_c l_c} اور  میکانی کثافت  \عددیء{\rho_c} ہو، کی کمیت \عددیء{m_c=\rho_c A_c l_c} ہو گی لہٰذا  ایک کلوگرام  قالب کے لئے مساوات \حوالہ{مساوات_مقناطیسی_دور_درکار_دباو_ضرب_رو} کو  درج ذیل روپ میں لکھا جا سکتا ہے۔
\begin{align}
