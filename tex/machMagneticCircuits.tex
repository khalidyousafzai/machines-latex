...
\end{align*}
یوں \عددیء{ 3 } ملی میٹر  خلاء کو \عددیء{0.003 \times 795775=2387} ایمپیئر چکر درکار ہوں گے۔ کُل ایمپیئر-چکر ان دونوں کا مجموعہ \عددیء{3.366+2387=2390.366} ہو گا جس سے  درج ذیل حاصل ہوتا ہے۔
\begin{align*}
...
\end{align*}
ایمپیئر-چکر فی میٹر درکار ہیں لہٰذا \عددیء{3} ملی میٹر لمبی خلاء کو  \عددیء{0.003 \times 1591549=4775}  ایمپیئر چکر درکار ہوں گے۔یوں کُل ایمپیئر-چکر \عددیء{3000+4775=7775} ہیں جن سے  درج ذیل حاصل کیا جا سکتا ہے۔
\begin{align*}
