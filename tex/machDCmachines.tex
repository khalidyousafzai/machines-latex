...
شکل  \حوالہ{شکل_یکسمتی_سمتکار_بش_کسر_دور_نہیں_کر_رہا} میں  گھومتے حصہ کو ایک دندان کے برابر حرکت دینے سے  دوبارہ یہی شکل حاصل ہوتی ہے لہٰذا ایک دندان حرکت کے بعد حاصل برقی دباو بھی دوبارہ وہی ہو گا۔اگر میکانی سمت کار کی فی قطب دندوں کی تعداد زیادہ کر دی جائے تب ایک دندان کے برابر حرکت قابل نظر انداز ہو گی۔ اب اگر خلائی درز میں کثافت مقناطیسی بہاو ہمواری کے ساتھ تبدیل ہو تو اتنی کم حرکت کے احاطے میں \عددیء{B_m} کی قیمت میں خاص تبدیلی نہیں آئے گی اور اس احاطے میں اسے یکساں تصور کیا جا سکتا ہے۔یوں اگر لچھا ایک دندان کے احاطے میں حرکت کرے تو اس میں محرک برقی دباو تبدیل نہیں ہو گا۔یعنی جس لچھے کا محرک برقی دباو  \عددیء{e_1} ہے اس لچھے کا  محرک برقی دباو ایک دندان احاطے میں یہی رہے گا۔یوں اگرچہ \عددیء{e_1,e_2,\cdots} ایک دوسرے سے مختلف ہو سکتے ہیں لیکن ان میں سے ہر ایک کی ایک مستقل قیمت ہو گی، لہٰذا  مساوات \حوالہ{مساوات_یکسمتی_کل_دباو_مجموعہ}  میں دیا گیا محرک برقی دباو بھی ایک مستقل ہو گا۔ 
...
%
\ابتدا{مثال}
دو قطب بارہ دندی میکانی سمت کار کے یک سمت  جنریٹر میں ہر قوی لچھا بیس چکر کا ہے۔ایک لچھے سے گزرتی مقناطیسی بہاو  \عددیء{0.0442} ویبر ہے۔جنریٹر \عددیء{3600} چکر فی منٹ کی رفتار سے گھوم رہا ہے۔
\begin{itemize}
\item
