...
\end{align}
سلسلہ وار جڑا جنریٹر میں میدانی برقی رو جنریٹر کے قوی لچھے کی  برقی رو ہو گی  لہٰذا سلسلہ وار جنریٹر کے لئے مساوات \حوالہ{مساوات_یک_سمت_میدانی_دباو} درج ذیل صورت اختیار کرتی ہے۔
\begin{align}
\tau_{m,s}=N_m I_q
\end{align}
