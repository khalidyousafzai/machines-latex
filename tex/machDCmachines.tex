...
\end{align}
خلائی درز میں یکساں \عددیء{B_m} کی صورت میں تمام لچھوں میں ایک سا  محرک برقی دباو پیدا ہو گا۔یوں شکل \حوالہ{شکل_یکسمتی_سمتکار_بش_کسر_دور_نہیں_کر_رہا}  میں دکھائے لمحہ پر  (شکل \حوالہ{شکل_یکسمتی_سمتکار_سے_جڑے_لچھے} سے رجوع کریں) جنریٹر کا کل محرک برقی دباو \عددیء{e}،  ایک لچھے کے محرک برقی دباو کا چار گنا ہو گا 
\begin{gather}
\begin{aligned}
