...
مساوات \حوالہ{مساوات_گھومتے_مشین_پھیلا_سائن_نما} کے تحت  شکل \حوالہ{شکل_گھومتے_مشین_گچھ_لچھا}  کا لچھے اور  شکل \حوالہ{شکل_گھومتے_مشین_رداس_اور_مقناطیسی_بہاو}  میں  صفر زاویہ پر سلاخ نما مقناطیس یکساں \عددی{\tau} (اور \عددی{B}) دیں گے۔ اسی طرح اگر شکل \حوالہ{شکل_گھومتے_مشین_گچھ_لچھا}  کا لچھا  زاویہ \عددیء{\theta_m}  پر  ہوتا تب ہمیں  شکل \حوالہ{شکل_گھومتے_مشین_رداس_اور_مقناطیسی_بہاو_مقناطیس_گھوما_ہے}  میں موجود مقناطیس کے نتائج حاصل ہوتے۔
 ...
 شکل \حوالہ{شکل_گھومتے_مشین_تین_دور_لچھے}  میں تین لچھے آپس میں \عددی{120^{\circ}} زاویہ پر دکھائے گئے ہیں۔ ہم مساوات \حوالہ{مساوات_گھومتے_مشین_کثافت_بالمقابل_زاویہ}   کی طرح اس شکل میں لچھا  \عددیء{a} کے لئے درج ذیل لکھ سکتے ہیں۔
\begin{figure}
\centering
...
\end{aligned}
\end{gather}
اسی طرح لچھا \عددیء{b} اور \عددیء{c} جو بالترتیب \عددیء{\theta_{m_b}=120^{\circ}} اور \عددیء{\theta_{m_c}=240^{\circ}}  زاویہ پر ہیں کے لئے درج ذیل ہو گا۔
\begin{gather}
...
\end{align}
میکانی قوت مروڑ بذریعہ ہم توانائی حاصل کی جا سکتی ہے۔ صفحہ \حوالہصفحہ{مساوات_تبادلہ_کوتوانائی_از_خود} پر مساوات \حوالہ{مساوات_تبادلہ_کوتوانائی_از_خود}  سے  ہم توانائی  حاصل  کی جائے  گی۔یہ مساوات موجودہ استعمال کے لئے درج ذیل صورت اختیار کرتی ہے۔
\begin{align}
