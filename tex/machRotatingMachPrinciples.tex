...
جیسا پہلے بھی ذکر کیا گیا چھوٹی گھومتی مشینوں میں مقناطیسی میدان ایک مقناطیس  فراہم کرتا ہے جبکہ بڑی مشینوں میں برقی مقناطیس  میدان فراہم کرتا ہے۔اگرچہ اب تک کی اشکال میں مقناطیس کو گھومتا حصہ دکھایا گیا ہے، حقیقت میں مقناطیس  کسی مشین میں گھومتا اور کسی میں  ساکن ہو گا۔ میدان فراہم کرنے والا لچھا مشین کے کل برقی طاقت کے چند فی صد برابر برقی طاقت استعمال کرتا ہے۔میدان فراہم کرنے والے اس لچھے کو \اصطلاح{میدانی لچھا}\فرہنگ{لچھا!میدانی}\حاشیہب{field coil}\فرہنگ{field coil}  کہتے ہیں۔اس کے برعکس مشین میں موجود دوسری نوعیت کے لچھے کو \اصطلاح{قوی لچھا}\فرہنگ{لچھا!قوی}\حاشیہب{power coil or rotor coil or armature coil}\فرہنگ{armature coil}  کہتے ہیں۔برقی جنریٹر کے قوی لچھے سے  برقی طاقت  حاصل کی جاتی ہے ۔برقی موٹروں میں میدانی لچھے میں چند فی صد برقی طاقت کے ضیاع کے علاوہ  تمام برقی طاقت  قوی لچھے کو فراہم کی جاتی ہے۔
\begin{figure}
\centering
...
ترسیمات \عددی{\tau_{a45}}، \عددی{\tau_{a90}} اور \عددی{\tau_{a135}} سے کل مقناطیسی دباو کی ترسیم \عددی{\tau}  حاصل کرنا سیکھتے ہیں۔شکل \حوالہ{شکل_گھومتے_مشین_پھیلے_لچھے_کی_دباو} میں عمودی نقطہ دار لکیریں لگائی گئی ہیں۔ سب سے بائیں  پہلی لکیر کی بائیں طرف خطہ کو \قول{ا} کہا گیا ہے۔اس خطہ میں ترسیمات \عددی{\tau_{a45}}، \عددی{\tau_{a90}} اور \عددی{\tau_{a135}} کی انفرادی قیمتیں \عددیء{-\tfrac{Ni}{6}} ہیں لہٰذا ان کا مجموعہ \عددیء{-\tfrac{Ni}{2}} ہو گا۔یوں خطہ \قول{ا} میں  کل مقناطیسی دباو \عددی{\tau}  کی ترسیم کی قیمت \عددیء{-\tfrac{Ni}{2}}  ہو گی۔ اسی طرح خطہ \قول{ب} میں \عددی{\tau_{a45}} کی قیمت \عددیء{+\tfrac{Ni}{6}} ، \عددی{\tau_{a90}} کی \عددیء{-\tfrac{Ni}{6}} اور \عددی{\tau_{a135}} کی بھی \عددیء{-\tfrac{Ni}{6}} ہے۔ ان کا مجموعہ \عددیء{-\tfrac{Ni}{6}}  ہے جو کل مقناطیسی دباو \عددی{\tau} ہو گا۔خطہ \قول{ج} میں  بالائی تینوں ترسیمات کی قیمتیں بالترتیب  \عددیء{+\tfrac{Ni}{6}}، \عددیء{+\tfrac{Ni}{6}} اور \عددیء{-\tfrac{Ni}{6}}  ہیں جن کا مجموعہ \عددیء{+\tfrac{Ni}{6}}  کل مقناطیسی دباو ہو گا۔ اسی طرح آپ پوری ترسیم کھینچ سکتے ہیں۔
...
پھیلے لچھے کے مختلف حصے ایک ہی زاویہ پر مقناطیسی دباو نہیں بناتے لہٰذا ان سے حاصل کل مقناطیسی دباو کا حیطہ  (اتنے ہی چکر کے) ایک گچھ لچھے   کے حیطہ سے  کم ہوتا ہے۔مساوات \حوالہ{مساوات_گھومتے_مشین_دباو_چوٹی} میں اس اثر کو شامل کرنے کے لیے جزو \عددیء{k_w}  متعارف کیا جاتا ہے
\begin{gather}
\begin{aligned}
...
کل مقناطیسی دباو جو پہلے صفر زاویہ پر تھا اب  گھڑی کے مخالف رخ گھوم کر \عددیء{30^{\circ}}  زاویہ پر ہے۔ اسی طرح لمحہ  \عددیء{\omega t =45^{\circ}} پر حل کرنے سے   زاویہ   \عددیء{45^{\circ}}   پر کل مقناطیسی دباو  \عددیء{\tfrac{3}{2}\tau_0}  حاصل ہو گا۔عمومی لمحہ \عددی{t}، جس پر  \عددیء{\omega t=\theta^{\circ}}  ہو، زاویہ  \عددیء{\theta^{\circ}} پر  کل مقناطیسی دباو  \عددیء{\tfrac{3}{2}\tau_0}  پیدہو گا۔
...
\end{aligned}
\end{gather}
خلائی درز میں کل مقناطیسی دباو \عددی{\tau_{ar}} درج ذیل مقناطیسی شدت \عددیء{H_{ar}} پیدا کرے گا جہاں \عددی{l_g} خلائی درز کی لمبائی ہے۔
\begin{align}
\tau_{ar}=H_{ar} l_g
\end{align}
...
\end{aligned}
\end{gather}
یوں خلائی درز میں، جہاں مقناطیسی میدان کا حیطہ \عددی{H_{ar}} ہے،  اوسط ہم توانائی کی کثافت \عددیء{\tfrac{\mu_0}{2}\tfrac{H_{ar}^2}{2}} ہو گی۔ خلائی درز میں اوسط ہم توانائی اور خلاء کے حجم کا حاصل  ضرب  درز میں  کل ہم توانائی \عددی{W_m'}   دے گا:
\begin{align}
...
\end{align}
ہوں گے۔ مساوات \حوالہ{مساوات_گھومتے_مشین_مروڑ_اور_بہاو} معاصر مشینوں  کے لیے بہت کار آمد ہے۔
