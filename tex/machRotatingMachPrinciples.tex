...
\end{itemize}
 ...
 شکل \حوالہ{شکل_گھومتے_مشین_دو_قطب_تین_دور_معاصر} میں  لچھا \عددیء{a}   کا برقی رو  شگاف \عددیء{a} میں،  کتاب کے صفحہ کو عمودی،  باہر رخ جبکہ  \عددیء{a'}  میں اس کے مخالف اندر رخ تصور کرتے ہوئے  لچھا \عددیء{a} کا رخ تیر دار لکیر سے دکھایا گیا ہے۔ اس رخ کو ہم صفر زاویہ تصور کرتے ہیں۔ یوں لچھا \عددیء{a}  صفر زاویہ پر لپیٹا گیا ہے، یعنی \عددیء{\theta_a=0^{\circ}} ہے۔ باقی لچھوں کے زاویات   لچھا \عددیء{a} کے رخ سے، گھڑی کے مخالف رُخ ناپے جاتے ہیں۔
