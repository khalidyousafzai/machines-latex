...
\end{align}
یہاں سمتی رفتار سے مراد برقی میدان کے لحاظ سے برقی بار کی سمتی رفتار ہے لہٰذا \عددی{\kvec{F}} کو ساکن مقناطیسی میدان میں برقی بار کی سمتی رفتار تصور کیا جا سکتا ہے۔مثبت برقی بار پر  قوت کا رخ  \اصطلاح{دائیں ہاتھ کا قانون}\حاشیہب{right hand rule} دیگا۔دائیں ہاتھ کا انگوٹھا، شہادت کی انگلی اور  بڑی انگلی کو ایک دوسرے کے ساتھ \عددی{90^{\circ}} زاویہ پر رکھتے ہوئے اگر شہادت کی انگلی \عددی{\kvec{v}} اور بڑی انگلی  \عددی{\kvec{B}} کے رخ ہوں تب انگوٹھا \عددی{\kvec{F}} کا رخ دیگا (صفحہ \حوالہصفحہ{شکل_تبادلہ_توانائی_دائیں_ہاتھ_قانون} پر شکل \حوالہ{شکل_تبادلہ_توانائی_دائیں_ہاتھ_قانون})۔
