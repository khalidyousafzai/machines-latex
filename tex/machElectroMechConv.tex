...
\end{align}
ہو گا جس کو مساوات \حوالہ{مساوات_برقی_مقناطیسی_تبادلہ_توانائی_کا_طریقہ} کے ساتھ ملا کر درج ذیل اخذ  کیا جا سکتا ہے جہاں ایک متغیر کے ساتھ تفرق لیتے ہوئے دوسرے کو صریحاً مستقل ظاہر کیا گیا ہے۔
\begin{align}
...
\end{align}
یوں اگر ہم مقناطیسی میدان میں مقناطیسی توانائی \عددیء{W_m(x,\lambda)} معلوم کر سکیں تب مساوات \حوالہ{مساوات_تبادلہ_توانائی_قوت_برقی_رو}   استعمال کر کے ہم قوت  دریافت کر سکتے ہیں۔ اگلے حصہ میں ہم یہی کریں گے۔
...
&=\num{-28278}
\end{align*}
نیوٹن حاصل ہوتی ہے۔قوت کی علامت منفی ہے جس کے تحت قوت   گھٹے \عددی{x} رخ ہو گی۔یوں حرکی حصہ بائیں رخ کھینچا جائے گا۔ 
\انتہا{مثال}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\حصہ{توانائی اور ہمہ توانائی}
	شکل \حوالہ{شکل_تبادلہ_توانائی_کو_توانائی_کی_تعریف}  میں \عددیء{\lambda} اور \عددیء{i} کے مابین ترسیم دکھایا گیا ہے۔ جیسا آپ دیکھ سکتے ہیں کہ لکیر کے نیچے رقبہ دراصل توانائی ہی ہے۔ اگر ہم اس ترسیم پر کوئی ایک نقطہ \عددیء{(\lambda,i)} لیں اور اس نقطے سے ایک لکیر نیچے کی طرف اور دوسری لکیر بائیں جانب کھینچے تو ہمیں ایک مستطیل ملتا ہے جس کا رقبہ \عددیء{\lambda i} کے برابر ہو گا۔ اگر اس میں سے ہم توانائی  \عددیء{W_m} منفی کر لیں تو جو مقدار ملتی ہے اس کو ہمہ توانائی \عددیء{W_m'} کہتے ہیں یعنی
\begin{figure}
\centering
...
\partial z(x,y)=\frac{\partial z}{\partial x} \dif x+\frac{\partial z}{\partial y} \dif y
\end{align*}
ہے۔یوں ہم  ہمہ توانائی \عددیء{W_m'(x,i)} کے لئے لکھ سکتے ہیں
\begin{align}
...
\end{align}
حاصل ہوتے ہیں۔قوت معلوم کرنے  کی یہ دوسری مساوات ہے۔ اس مساوات میں ہمہ توانائی استعمال ہوتی ہے جبکہ مساوات \حوالہ{مساوات_تبادلہ_توانائی_قوت_برقی_رو} میں  توانائی کے ذریعہ قوت  حاصل کی گئی۔
...
اس پیچدار لچھے پر  برقی رو \عددیء{I_0} گزارنے سے رداسی رخ میکانی دباو یعنی قوت فی مربع رقبہ پیدا ہو گا۔میری \عددیء{3000} کلوگرام لوہا پگھلانے کی بھٹی کے پیچدار لچھے کی تفصیل کچھ یوں ہے۔
\begin{align*}
...
\end{align}
اسی طرح مساوات \حوالہ{مساوات_تبادلہ_اصل_راستے_تکمل_کا_جواب}  کی جگہ ہمہ توانائی کے لئے حاصل ہوتا ہے
\begin{align}
...
حل:مساوات \حوالہ{مساوات_تبادلہ_کوتوانائی_از_خود} سے ہمہ توانائی حاصل ہوتی ہے اور مساوات \حوالہ{مساوات_تبادلہ_کوتوانائی_سے_مروڑ}  کے آخری جزو سے قوت مروڑ یعنی
\begin{align*}
